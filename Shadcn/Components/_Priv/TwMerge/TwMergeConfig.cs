...
using V = Shadcn.TwMerge.Commom.Validators;
using Shadcn.TwMerge.Commom;
using Shadcn.TwMerge.Models;

namespace Shadcn.TwMerge;
...
public class TwMergeConfig {
    ...
    public TwMergeConfig() {
        ...
        string[] breakScale = new string[] { "auto", "avoid", "all", "avoid-page", "page", "left", "right", "column" };
        string[] positionScale = new string[] {
                "bottom",
            "center",
            "left",
            "left-bottom",
        ...
        string[] overflowScale = new string[] { "auto", "hidden", "clip", "visible", "scroll" };
        string[] overscrollScale = new string[] { "auto", "contain", "none" };
        string[] alignPrimaryAxisScale = new string[] { "start", "end", "center", "between", "around", "evenly", "stretch", "baseline" };
        string[] alignSecondaryAxisScale = new string[] { "start", "end", "center", "stretch" };
        string[] lineStyleScale = new string[] { "solid", "dashed", "dotted", "double" };
        string[] blendModeScale = new string[] {
                "normal",
            "multiply",
            "screen",
            "overlay",
        ...
        object[] unambiguousSpacingScale = new object[] { V.IsArbitraryVariable, V.IsArbitraryValue, spacingTheme };
        object[] insetScale = new object[] { "full", "auto", V.IsFraction }.Concat(unambiguousSpacingScale).ToArray();
        object[] gridTemplateColsRowsScale = new object[] { "none", "subgrid", V.IsInteger, V.IsArbitraryValue, V.IsArbitraryVariable };
        object[] gridColRowStartAndEndScale = new object[] {
                "auto",
                new ClassGroup("span", new object[] { "full", V.IsInteger, V.IsArbitraryValue, V.IsArbitraryVariable }),
                V.IsArbitraryValue,
                V.IsArbitraryVariable
            };
        object[] gridColRowStartOrEndScale = new object[] { "auto", V.IsInteger, V.IsArbitraryValue, V.IsArbitraryVariable };
        object[] gridAutoColsRowsScale = new object[] { "auto", "min", "max", "fr", V.IsArbitraryValue, V.IsArbitraryVariable };
        object[] marginScale = new object[] { "auto" }.Concat(unambiguousSpacingScale).ToArray();
        object[] sizingScale = new object[] {
                "auto",
                "full",
                "dvw",
                "dvh",
                ...
                "fit",
                V.IsFraction
            }.Concat(unambiguousSpacingScale).ToArray();
        object[] colorScale = new object[] { colorTheme, V.IsArbitraryValue, V.IsArbitraryVariable };

        object[] gradientStopPositionScale = new object[] { V.IsPercent, V.IsArbitraryLength };

        object[] radiusScale = new object[] { 
        ...
        object[] borderWidthScale = new object[] { "", V.IsNumber, V.IsArbitraryLength, V.IsArbitraryVariableLength };
        object[] blurScale = new object[] { 
                // Deprecated since Tailwind CSS v4.0.0
                "",
                "none",
                V.IsNumber,
        ...
        object[] rotateScale = new object[] { "none", V.IsNumber, V.IsArbitraryValue, V.IsArbitraryVariable };
        object[] scaleScale = new object[] { "none", V.IsNumber, V.IsArbitraryValue, V.IsArbitraryVariable };
        object[] skewScale = new object[] { V.IsNumber, V.IsArbitraryValue, V.IsArbitraryVariable };
        object[] traslateScale = new object[] { "full", V.IsFraction }.Concat(unambiguousSpacingScale).ToArray();
        CacheSize = 500;
        Theme = new Dictionary<string, object[]>() {
            ["animate"] = new object[] { "spin", "ping", "pulse", "bounce" },
            ["aspect"] = new object[] { "video" },
            ["blur"] = new object[] { V.IsTshirtSize },
            ["breakpoint"] = new object[] { V.IsTshirtSize },
            ["color"] = new object[] { V.IsAny },
            ["container"] = new object[] { V.IsTshirtSize },
            ["drop-shadow"] = new object[] { V.IsTshirtSize },
            ["ease"] = new object[] { "in", "out", "in-out" },
            ["font"] = new object[] { V.IsAnyNonArbitrary },
            ["font-weight"] = new object[] {
                    "thin",
                    "extralight",
                    "light",
                    "normal",
            ...
            ["inset-shadow"] = new object[] { V.IsTshirtSize },
            ["leading"] = new object[] { "none", "tight", "snug", "normal", "relaxed", "loose" },
            ["perspective"] = new object[] { "dramatic", "near", "normal", "midrange", "distant", "none" },
            ["radius"] = new object[] { V.IsTshirtSize },
            ["shadow"] = new object[] { V.IsTshirtSize },
            ["spacing"] = new object[] { "px", V.IsNumber },
            ["text"] = new object[] { V.IsTshirtSize },
            ["tracking"] = new object[] { "tighter", "tight", "normal", "wide", "wider", "widest" },
        };
        ...
        ClassGroups = new(270) {
            ...
            */
            ["aspect"] = new ClassGroup("aspect", new object[] {
                    "auto",
                    "square",
                    aspectTheme,
                    V.IsFraction,
             ...
             * Deprecated since Tailwind CSS v4.0.0
             */
            ["container"] = new ClassGroup("container", new object[] { }),
            /*
             * Columns
             * See https://tailwindcss.com/docs/columns
             */
            ["columns"] = new ClassGroup("columns", new object[] {
                    containerTheme,
                    V.IsNumber,
                    V.IsArbitraryValue,
                    V.IsArbitraryVariable
             ...
             */
            ["break-inside"] = new ClassGroup("break-inside", new object[] { "auto", "avoid", "avoid-page", "avoid-column" }),
            /*
             * Box Decoration Break
             * See https://tailwindcss.com/docs/box-decoration-break
             */
            ["box-decoration"] = new ClassGroup("box-decoration", new object[] { "slice", "clone" }),
            /*
             * Box Sizing
             * See https://tailwindcss.com/docs/box-sizing
             */
            ["box"] = new ClassGroup("box", new object[] { "border", "content" }),
            /*
             * Display
             * See https://tailwindcss.com/docs/display
             */
            ["display"] = new ClassGroup("display", new object[] {
                    "block",
                    "inline-block",
                    "inline",
                    "flex",
             ...
             */
            ["sr"] = new ClassGroup("sr", new object[] { "sr-only", "not-sr-only" }),
            /*
             * Floats
             * See https://tailwindcss.com/docs/float
             */
            ["float"] = new ClassGroup("float", new object[] { "right", "left", "none", "start", "end" }),
            /*
             * Clear
             * See https://tailwindcss.com/docs/clear
             */
            ["clear"] = new ClassGroup("clear", new object[] { "left", "right", "both", "none", "start", "end" }),
            /*
             * Isolation
             * See https://tailwindcss.com/docs/isolation
             */
            ["isolation"] = new ClassGroup("isolation", new object[] { "isolate", "isolation-auto" }),
            /*
             * Object Fit
             * See https://tailwindcss.com/docs/object-fit
             */
            ["object-fit"] = new ClassGroup("object-fit", new object[] { "contain", "cover", "fill", "none", "scale-down" }),
            /*
             * Object Position
             * See https://tailwindcss.com/docs/object-position
             */
            ["object-position"] = new ClassGroup("object-position", new object[] {
                    positionScale.Concat(new object[] { V.IsArbitraryValue, V.IsArbitraryVariable }).ToArray()
                }),
            /*
             * Overflow
             ...
             */
            ["position"] = new ClassGroup("position", new object[] { "static", "fixed", "absolute", "relative", "sticky" }),
            /*
             ...
             */
            ["visibility"] = new ClassGroup("visibility", new object[] { "visible", "invisible", "collapse" }),
            /*
             * Z-Index
             ...
             * See https://tailwindcss.com/docs/space
             */
            ["space-x-reverse"] = new("space-x-reverse", unambiguousSpacingScale),
            /*
             * Space Between Y
             * See https://tailwindcss.com/docs/space
             */
             ...
             * See https://tailwindcss.com/docs/space
             */
            ["space-y-reverse"] = new ClassGroup("space-y-reverse", unambiguousSpacingScale),
             ...
             */
            ["font-smoothing"] = new("font-smoothing", new object[] { "antialiased", "subpixel-antialiased" }),
            /*
             * Font Style
             * See https://tailwindcss.com/docs/font-style
             */
            ["font-style"] = new("font-style", new object[] { "italic", "not-italic" }),
            /*
             * Font Weight
             ...
             */
            ["fvn-normal"] = new("fvn-normal", new object[] { "normal-nums" }),
            /*
             * Font Variant Numeric
             * See https://tailwindcss.com/docs/font-variant-numeric
             */
            ["fvn-ordinal"] = new("fvn-ordinal", new object[] { "ordinal" }),
            /*
             * Font Variant Numeric
             * See https://tailwindcss.com/docs/font-variant-numeric
             */
            ["fvn-slashed-zero"] = new("fvn-slashed-zero", new object[] { "slashed-zero" }),
            /*
             * Font Variant Numeric
             * See https://tailwindcss.com/docs/font-variant-numeric
             */
            ["fvn-figure"] = new("fvn-figure", new object[] { "lining-nums", "oldstyle-nums" }),
            /*
             * Font Variant Numeric
             * See https://tailwindcss.com/docs/font-variant-numeric
             */
            ["fvn-spacing"] = new("fvn-spacing", new object[] { "proportional-nums", "tabular-nums" }),
            /*
             * Font Variant Numeric
             * See https://tailwindcss.com/docs/font-variant-numeric
             */
            ["fvn-fraction"] = new("fvn-fraction", new object[] { "diagonal-fractions", "stacked-fractions" }),
            /*
             * Letter Spacing
             ...
             */
            ["text-decoration"] = new("text-decoration", new[] { "underline", "overline", "line-through", "no-underline" }),
            /*
             ...
             */
            ["text-transform"] = new("text-transform", new object[] { "uppercase", "lowercase", "capitalize", "normal-case" }),
            /*
             * Text Overflow
             * See https://tailwindcss.com/docs/text-overflow
             */
            ["text-overflow"] = new("text-overflow", new object[] { "truncate", "text-ellipsis", "text-clip" }),
            /*
             * Text Wrap
             ...
             * See https://tailwindcss.com/docs/divide-width
             */
            ["divide-x-reverse"] = new("divide-x-reverse", new object[] { "divide-x-reverse" }),
            /*
             * Divide Width Y
             * See https://tailwindcss.com/docs/divide-width
             */
             ...
             * See https://tailwindcss.com/docs/divide-width
             */
            ["divide-y-reverse"] = new("divide-y-reverse", new object[] { "divide-y-reverse" }),
            /*
             * Border Style
             ...
             */
            ["ring-w-inset"] = new("ring-w-inset", new[] { "ring-inset" }),
            /*
             * Ring Color
             ...
             * See https://tailwindcss.com/docs/scale
             */
            ["scale-3d"] = new("scale-3d", new[] { "scale-3d" }),
            /*
             * Skew
             ...
             * See https://tailwindcss.com/docs/translate
             */
            ["translate-none"] = new("translate-none", new object[] { "translate-none" }),
             ...
             * See https://tailwindcss.com/docs/touch-action
             */
            ["touch-pz"] = new("touch-pz", new[] { "touch-pinch-zoom" }),
            /*
             * User Select
